...
export const TweetSkeleton = ({ className, ...props }: { className?: string; [key: string]: any }) => (
  <div
    className={cn('flex h-full max-h-max w-full min-w-[18rem] flex-col gap-2 rounded-lg border p-4', className)}
    {...props}
  >
...
export const TweetNotFound = ({ className, ...props }: { className?: string; [key: string]: any }) => (
  <div
    className={cn('flex h-full w-full flex-col items-center justify-center gap-2 rounded-lg border p-4', className)}
    {...props}
  >
    ...
    <div className="flex items-center space-x-2">
      ...
      <div>
        ...
        >
          ...
          {tweet.user.verified ||
            (tweet.user.is_blue_verified && <Verified className="ml-1 inline h-4 w-4 text-blue-500" />)}
        </a>

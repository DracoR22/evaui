...
const techComponents: TechComponents = {
  nextjs: {
    name: 'Next.js 14',
    icon: (
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-8" fill="currentColor">
        <title>Next.js</title>
  ...
  react: {
    name: 'React',
    icon: (
      <svg role="img" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="size-8" fill="currentColor">
        <title>React</title>
  ...
  typescript: {
    name: 'Typescript ',
    icon: (
      <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className="size-8" fill="currentColor">
